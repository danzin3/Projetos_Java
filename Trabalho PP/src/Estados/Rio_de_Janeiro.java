 ...
 * @author Mr. DAN
 */
public class Rio_de_Janeiro implements Estado {

    private double tx_natalidade = 0.99, populacao = 17264943.00, resp = 0,mediaPop = 0 ;
    ...
    public double calcImposto(double valor) {
        return valor + (valor*0.1812);//0.1812 É a alícota do imposto desse Estado
    }
