 ...
 * @author Mr. DAN
 */
public class Rio_Grande_do_Sul implements Estado{

    private double tx_natalidade = 0.96, populacao = 11337239.00, resp = 0,mediaPop = 0 ;
    ...
    public double calcImposto(double valor) {
        return valor + (valor*0.179);//0.179 É a alícota do imposto desse Estado
    }
