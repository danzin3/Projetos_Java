 ...
 * @author Mr. DAN
 */
public class Minas_Gerais implements Estado {

    private double tx_natalidade = 1.25, populacao = 21168791.00, resp = 0,mediaPop = 0 ;
    ...
    public double calcImposto(double valor) {
        return valor + (valor*0.18);//0.18 É a alícota do imposto desse Estado
    }
