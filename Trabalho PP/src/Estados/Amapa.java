 ...
 * @author Mr. DAN
 */
public class Amapa implements Estado {

    private double tx_natalidade = 2.32, populacao = 845731.00, resp = 0,mediaPop = 0 ;
    ...
    public double calcImposto(double valor) {
        return valor + (valor*0.175);//0.175 É a alícota do imposto desse Estado
    }
