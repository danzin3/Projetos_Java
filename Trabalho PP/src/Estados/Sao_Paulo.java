 ...
 * @author Mr. DAN
 */
public class Sao_Paulo implements Estado {

    private double tx_natalidade = 1.10, populacao = 45919049.00, resp = 0,mediaPop = 0 ;
    ...
    public double calcImposto(double valor) {
        return valor + (valor*0.19);//0.19 É a alícota do imposto desse Estado
    }
