 ...
 * @author Mr. DAN
 */
public class Ceara implements Estado {

    private double tx_natalidade = 1.49, populacao = 9132078.00, resp = 0,mediaPop = 0 ;
    ...
    public double calcImposto(double valor) {
        return valor + (valor*0.1822);//0.1822 É a alícota do imposto desse Estado
    }
